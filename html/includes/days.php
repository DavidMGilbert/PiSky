	...
	<table style='margin-top: 15px; text-align:center'>
	  ...
	  <tbody>
		<tr>
			...
			<td>-</td>
			<td><a href='/admin/?page=list_videos&day=All' title='All Timelapse (CAN BE SLOW TO LOAD)'><i class='fa fa-film fa-lg fa-fw'></i></a></td>
			<td><a href='/admin/?page=list_keograms&day=All' title='All Keograms'><i class='fa fa-barcode fa-lg fa-fw'></i></a></td>
			<td><a href='/admin/?page=list_startrails&day=All' title='All Startrails'><i class='fa fa-star fa-lg fa-fw'></i></a></td>
...
foreach ($days as $day) {
	...
	echo "\t\t\t<td>";
	echo "<a href='/admin/?page=list_images&day=$day' title='Images'><i class='fa fa-image fa-lg fa-fw'></i></a>";
	echo "</td>\n";

	echo "\t\t\t<td>";
	if (glob(ALLSKY_IMAGES . "/$day/*.mp4") != false) {
		echo "<a href='/admin/?page=list_videos&day=$day' title='Timelapse'><i class='fa fa-film fa-lg fa-fw'></i></a>";
	} else {
		echo "none";
	}
	echo "</td>\n";
	...
	if (is_dir($d)) {
		echo "<a href='/admin/?page=list_keograms&day=$day' title='Keogram'><i class='fa fa-barcode fa-lg fa-fw'></i></a>";
	} else {
		echo "none";
	}
	echo "</td>\n";
	...
	if (is_dir($d)) {
		echo "<a href='/admin/?page=list_startrails&day=$day' title='Startrails'><i class='fa fa-star fa-lg fa-fw'></i></a>";
	} else {
		echo "none";
	}
	echo "</td>\n";
