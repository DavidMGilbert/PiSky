...
<div class="row pisky-allsky-settings"> <div class="col-lg-12"> <div class="panel panel-primary">
<?php
	...
	echo "<div class='panel-heading'><span class='pisky-eyebrow'>Camera configuration</span><h1>$x Allsky Settings <small>$cameraType $cameraModel</small></h1></div>";
...
CSRFToken();
		...
		$sourceFiles = array();
		$sourceFilesContents = array();
		echo "<table border='0' width='100%' class='pisky-settings-table'>";
			$inHeader = false;
			$onHeader = 0;
