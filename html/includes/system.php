			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					if (isset($_POST['system_reboot'])) {
						...
						runCommand("sudo /bin/systemctl start allsky && sleep 4", "PiSky capture started", "success");
						$s = true;
					} else if (isset($_POST['service_stop'])) {
						runCommand("sudo /bin/systemctl stop allsky && sleep 3", "PiSky capture stopped", "success");
						$s = true;
					}
					if ($s) {
					...
					<div style="margin-bottom: 15px">
						<button type="submit" class="btn btn-success" name="service_start"/>
							<i class="fa fa-play"></i> Start capture</button>
						&nbsp;
						<button type="submit" class="btn btn-danger" name="service_stop"/>
							<i class="fa fa-stop"></i> Stop capture</button>
					</div>
